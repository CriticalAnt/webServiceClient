...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.test.client.HelloWorldService {
    ...
    public com.test.client.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.test.client.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.test.client.HelloWorldSoapBindingStub _stub = new com.test.client.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.test.client.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.test.client.HelloWorldSoapBindingStub _stub = new com.test.client.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
